function [xsol, L1_v, L1_vp, L2_v, L2_vp, delta_v, sol_v, snr_v, no_sub_itr_v, v1, v2, sol_reweight_v] = pdfb_bpcon_par_sim_rescaled_precond_wave_par(y, epsilont, epsilonts, epsilon, epsilons, A, At, T, pU, W, Psi, Psit, Psiw, Psitw, param)
%
% [xsol, L1_v, L1_vp, L2_v, L2_vp, delta_v, sol_v, snr_v, no_sub_itr_v, v1, v2, sol_reweight_v] = pdfb_bpcon_par_sim_rescaled_precond_wave_par(y, epsilont, epsilonts, epsilon, epsilons, A, At, T, W, Psi, Psit, Psiw, Psitw, param)
% implements Algorithm 3 without randomisation as described in [1].
% The implementation partially distributes the computations.
% CUDA GPU support is required.
%
% Inputs:
...
for t = 1:param.max_iter    
    ...
    ns = gather(A(gpuArray(prev_xsol)));
